...
public class GameCanvas extends JPanel implements ActionListener {
    // instance variables
    private static final int SCREEN_HEIGHT = 625;
    private static final int SCREEN_WIDTH = 625;
    ...
    public void drawGridlines(Graphics g) {
        ...
        for (int i = 0; i < SCREEN_HEIGHT / cellSize; i++) {
            g.drawLine(i * cellSize, 0, i * cellSize, SCREEN_HEIGHT);
            g.drawLine(0, i * cellSize, SCREEN_WIDTH, i * cellSize);
        }
    ...
    public void spawnObstacle() {
        ...
        while (true) {
            spawnOnSnake = false;
            spawnOnApple = false;
            obstacleX = random.nextInt(SCREEN_HEIGHT / cellSize) * cellSize;
            obstacleY = random.nextInt(SCREEN_HEIGHT / cellSize) * cellSize;
    ...
    public void checkApple() {
        ...
        if ((head.getX() == apple.getX()) && (head.getY() == apple.getY())) {
            ...
            while (true) {
                apple.spawn(SCREEN_WIDTH, SCREEN_HEIGHT);
                spawnOnSnake = false;
    ...
    public void endGame(Graphics g) {
        ...
        int buttonX = (SCREEN_WIDTH - settingsButton.getPreferredSize().width) / 2;
        int buttonY = SCREEN_HEIGHT / 2 + 50;  // Adjust the Y-coordinate as needed
